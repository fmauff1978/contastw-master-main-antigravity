...
import { Timestamp, doc, collection, addDoc, updateDoc, increment } from 'firebase/firestore';
import { FirestoreService } from '../../../services/firestore.service';
import { TimestampService } from '../../../services/timestamp.service';
import { CommonModule } from '@angular/common';

@Component({
  selector: 'app-incrementaroutroscredores',
  imports: [CommonModule, FormsModule, ReactiveFormsModule],
  templateUrl: './incrementaroutroscredores.component.html',
  styleUrl: './incrementaroutroscredores.component.css'
})
export class IncrementaroutroscredoresComponent {
   ...
   fs = inject(FirestoreService);
    ...
    @Input() showModal5: boolean = false;
    ...
    async incrementar(id, valor, inc) {
      const docRef = doc(this.fs.db, 'outroscredores', id);
